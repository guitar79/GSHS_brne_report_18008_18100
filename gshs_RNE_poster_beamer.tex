...
\begin{posterbox}[colbacktitle=blue!50!black,coltitle=white,colback=cyan!5]{개발 내용 및 방법}
  \begin{itemize}
	...
	설계한 회로에 들어갈 펌웨어는 다양한 기능을 지원한다. 먼저, 메뉴 기능을 통해 모터를 연속적으로 돌리는 기능과 미리 설정한 일정 값을 돌릴 수 있도록 한다. 특히 연속적으로 돌리는 경우 가속기능을 추가하여 효율성을 높였다. 또한 모터를 얼마나 돌렸는지 표시하는 기능, 자신이 표시할 숫자를 정하는 기능 등을 포함하고 있다.
	\begin{figure}[h]
		\centering
