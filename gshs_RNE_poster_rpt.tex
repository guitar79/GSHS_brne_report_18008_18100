\documentclass{gshs_poster_rpt}



%%% title, authors, etc...
\postertitle{Write Your Title Here\\[0.3em] What happens for long title?}
\authorone{홍길동}
\authortwo{홍동길}
\authorthree{길홍동}
\teacher{허균}
...
\includegraphics[width=0.5\linewidth]{./figures/fig01.jpg}
\captionof{figure}{\color{red!60!black} caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here caption here }
\end{center}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{./figures/fig03.jpg}
\captionof{figure}{\color{red!60!black} caption here caption here caption here caption here caption here caption here caption here caption here}
\end{center}
