...
%the author(s)
{\color{white}\small
  \vspace{1em} 정기현, 곽지성\\[0.5em]
  Dept.\ of 융합과학, 경기과학고등학교
}
...
\begin{posterbox}[name=intro,column=0,row=0]{서론}
\begin{itemize}
...
\begin{posterbox}[name=usage,column=0,below=intro]{선행연구 고찰}
\begin{itemize}
...
\begin{posterbox}[name=lists,column=0,below=usage]{List of Items}
Itemize
\begin{itemize}
%  \item item 1
%    \begin{itemize}
